...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\AASHI\\Desktop\\AASHI CLG\\sem 5\\lab in psy\\tutorial-5\\tutorial5_lastrun.py',
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    test_2Components = [text_2, textbox, text_3, mouse]
